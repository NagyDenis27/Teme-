function success() {
  ...
  tag.setAttribute('style','background-color:  rgb(193, 253, 133); color: darkgreen; width: auto; height:40px; border : 2px solid rgb(113, 192, 77); border-radius: 7px; display: flex; justify-content: flex-start;  align-items:center; margin-left: 30%; margin-right:30%; font-size:larger ; font-weight:550 ; font-style: arial; padding:4px;',);
 ...
 function  error() {
  ...
  tag.setAttribute('style','background-color: rgb(110, 11, 0); color: white; width: auto; height:40px; border : 2px solid rgb(113, 192, 77); border-radius: 7px; display: flex; justify-content: flex-start;  align-items:center; margin-left: 30%; margin-right:30%; font-size:larger ; font-weight:550 ; font-style: arial; padding:4px;',);
